...
Each guide gives the shortest UI path for completing its task and an **API equivalent** that links to the reference. Request bodies and curl commands are maintained centrally in [API Examples](../api/examples.md).
